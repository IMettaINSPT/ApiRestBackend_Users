package com.tp.backend.personaDetenida.controller;

import com.tp.backend.personaDetenida.application.PersonaDetenidaUseCase;
...
public class PersonaDetenidaController {
    private final PersonaDetenidaUseCase service;

    public PersonaDetenidaController(PersonaDetenidaUseCase service) { this.service = service; }
